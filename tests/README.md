...
available [here](https://semaphoreci.com/bas-ansible-roles-collection/system-security).
...
| ------------------------------------- | ----------------- | ------------------------------------------- | --------------------------- |
| barc-system-security-test-ubuntu-bare | *computed value*  | `barc-system-security-test-ubuntu-bare.v.m` | The VM's private IP address |
| barc-system-security-test-centos-bare | *computed value*  | `barc-system-security-test-centos-bare.v.m` | The VM's private IP address |
